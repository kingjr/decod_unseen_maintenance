...
# COMPUTE
parallel --joblog job-pipeline.log --tag --delay 1 --slf running.slf $SSHLOGINS "bash cloud/run_remote.sh ${SCRIPT} --subject={1} --time_id=${TIME_ID};" ::: $SUBJECTS > output.log 2> error.log
