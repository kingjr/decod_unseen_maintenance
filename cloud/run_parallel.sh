...
# COMPUTE
parallel --joblog job-pipeline.log --resume --resume-failed --tag --delay 1 $SSHLOGINS "bash cloud/run_remote.sh ${SCRIPT} --subject={1} --time_id=${TIME_ID} --run=1" ::: $SUBJECTS > output.log 2> error.log
